...
SELECT
	...
	A.VL_INTER_TASK_EXECUTION_TIME - (VL_INTER_TASK_EXECUTION_TIME - (A.VL_INTRA_TASK_EXECUTION_TIME_DEVICE_FUNC + A.VL_COMMUNICATION_TIME)) AS VL_INTER_TASK_EXECUTION_TIME_FREE_OVERHEAD_FREE_ADITIONAL,
