...
SET search_path = schema_kmeans; --KMEANS
SET search_path = schema_matmul; --MATMUL
SET search_path = schema_matmul_fma; --MATMUL FMA


-- FOR GIT PROJECT (PAPER 1) -- END
...
-- MAIN EXPERIMENT QUERY (CPU-GPU CACHE)
SELECT
*
FROM
(
                        ...
                        SELECT
                        Y.VL_INTER_TASK_EXECUTION_TIME AS VL_PARALLEL_TASK_EXEC_TIME,
                        Y.VL_INTRA_TASK_EXECUTION_TIME_FULL_FUNC AS VL_USER_CODE_EXEC_TIME,
                        Y.VL_INTRA_TASK_EXECUTION_TIME_DEVICE_FUNC AS VL_PARALLEL_FRACTION_EXEC_TIME,
                        Y.VL_COMMUNICATION_TIME_1 AS CPU_GPU_COMMUNICATION_TIME,
						Y.VL_COMMUNICATION_TIME_2 AS GPU_CPU_COMMUNICATION_TIME,
						Y.VL_COMMUNICATION_TIME AS VL_TOTAL_COMMUNICATION_TIME,
                        Y.VL_ADDITIONAL_TIME AS VL_SERIAL_FRACTION_EXEC_TIME,
                        Y.ID_PARAMETER,
                        Y.CD_PARAMETER,
                        Y.CD_CONFIGURATION,
                        Y.ID_ALGORITHM,
...
AND ZZ.vl_grid_row_dimension = 32
...
ALTER TABLE DATASET ADD COLUMN VL_DATA_SKEWNESS DOUBLE PRECISION;
UPDATE DATASET SET VL_DATA_SKEWNESS = 0.0
...
'partial_sum' as "Task Algorithm",
ZZZ.VL_BLOCK_MEMORY_SIZE as "Block size",
ZZZ.VL_GRID_DIMENSION_SIZE as "Grid dimension",
ZZZ.P_FRACTION as "Parallel fraction",
ZZZ.PARAMETER_X as "Algorithm-specific param.",
'quadratic' as "Computational complexity",
ZZZ.DAG_MAX_WIDTH as "DAG maximum width",
ZZZ.DAG_MAX_HEIGHT as "DAG maximum height",
ZZZ.VL_DATASET_MEMORY_SIZE as "Dataset size",
(ZZZ.NR_NODES-1) as "#worker nodes",
ZZZ.CPU as "CPU",
ZZZ.GPU as "GPU",
ZZZ.SHARED_DISK as "Shared disk storage",
ZZZ.LOCAL_DISK as "Local disk storage",
...
-- QUERY TO EXTRACT CPU-GPU COMMUNICATION AND GPU-CPU COMMUNICATION
...
SELECT
                            ...
                            A.VL_INTRA_TASK_EXECUTION_TIME_FULL_FUNC,
                            A.VL_INTRA_TASK_EXECUTION_TIME_DEVICE_FUNC,
							NULL AS VL_COMMUNICATION_TIME_1,
							NULL AS VL_COMMUNICATION_TIME_2,
                            A.VL_COMMUNICATION_TIME,
                            A.VL_INTRA_TASK_EXECUTION_TIME_FULL_FUNC - (A.VL_INTRA_TASK_EXECUTION_TIME_DEVICE_FUNC+A.VL_COMMUNICATION_TIME) AS VL_ADDITIONAL_TIME,
                            (A.VL_INTRA_TASK_EXECUTION_TIME_DEVICE_FUNC + A.VL_COMMUNICATION_TIME) AS VL_INTRA_TASK_EXECUTION_TIME_FREE_ADDITIONAL,
                            B.ID_PARAMETER,
                        ...
                        Y.VL_INTRA_TASK_EXECUTION_TIME_FULL_FUNC,
                        Y.VL_INTRA_TASK_EXECUTION_TIME_DEVICE_FUNC,
						Y.VL_COMMUNICATION_TIME_1,
						Y.VL_COMMUNICATION_TIME_2,
                        Y.VL_COMMUNICATION_TIME,
                        Y.VL_ADDITIONAL_TIME,
                        (Y.VL_INTRA_TASK_EXECUTION_TIME_DEVICE_FUNC + Y.VL_COMMUNICATION_TIME) AS VL_INTRA_TASK_EXECUTION_TIME_FREE_ADDITIONAL,
                        Y.ID_PARAMETER,
