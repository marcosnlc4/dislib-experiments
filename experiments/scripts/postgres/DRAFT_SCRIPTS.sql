...
-- MODE 2: FIND WHERE CPUs HAVE A LOWER LATENCY THAN GPUs
SELECT
SBQ.ID_EXPERIMENT,
SBQ.ID_PARAMETER,
SBQ.CD_PARAMETER,
...
-- MODE 3: EVALUATE CASES WHERE CPUs HAVE A LOWER LATENCY THAN GPUs
SELECT
--SBQ.VL_DATASET_MEMORY_SIZE,
--SBQ.DS_DATASET,
--SBQ.DS_PARAMETER_TYPE,
...
AND SBQ.DS_PARAMETER_TYPE = 'VAR_PARALLELISM_LEVEL'--'VAR_BLOCK_CAPACITY_SIZE'
GROUP BY
--SBQ.VL_DATASET_MEMORY_SIZE
--SBQ.DS_DATASET
--SBQ.DS_PARAMETER_TYPE
