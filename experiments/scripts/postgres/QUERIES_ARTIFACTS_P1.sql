...
SELECT * FROM DATASET WHERE ID_DATASET IN (27,28,29,39)-- DS_DATASET IN ('S_1GB_1',S_1GB_3','S_10GB_1','S_100GB_1')
SELECT * FROM PARAMETER_TYPE WHERE ID_PARAMETER_TYPE BETWEEN 17 AND 28
SELECT * FROM PARAMETER WHERE ID_RESOURCE = 18 AND ID_DATASET IN (27,28,29,39) AND ID_PARAMETER_TYPE BETWEEN 17 AND 28
...
SELECT A.* FROM EXPERIMENT_RAW A INNER JOIN PARAMETER B ON (A.ID_PARAMETER = B.ID_PARAMETER) WHERE ID_RESOURCE = 18 AND ID_DATASET IN (27,28,29,39) AND ID_PARAMETER_TYPE BETWEEN 17 AND 28
...
SELECT * FROM PARAMETER WHERE ID_RESOURCE = 1 AND ID_DATASET IN (3,4,5,8,13) AND ID_PARAMETER_TYPE IN (1,2,5,6)
SELECT null as ID_EXPERIMENT, null as ID_PARAMETER, null as VL_TOTAL_EXECUTION_TIME, null as VL_INTER_TASK_EXECUTION_TIME, null as VL_INTRA_TASK_EXECUTION_TIME_FULL_FUNC, null as VL_INTRA_TASK_EXECUTION_TIME_DEVICE_FUNC, null as VL_COMMUNICATION_TIME, null as DT_PROCESSING FROM EXPERIMENT limit 1--NOT USED
...
-- #### FIGURE 10. The effects of storage architecture and scheduling policy on Matmul (MODE == 15) (MODE == 16 IN REVISION) ####
SELECT
	Y.VL_TOTAL_EXECUTION_TIME,
...
-- #### FIGURE 11. The effects of storage architecture and scheduling policy on K-means, 10 clusters (MODE == 15) (MODE == 16 IN REVISION) ####
SELECT
	Y.VL_TOTAL_EXECUTION_TIME,
	Y.VL_INTER_TASK_EXECUTION_TIME AS VL_PARALLEL_TASK_TIME,
	Y.VL_INTRA_TASK_EXECUTION_TIME_FULL_FUNC AS VL_USER_CODE_TIME,
...
-- #### EXTRA FIGURE 1 - LARGER DATASETS - PART 1 - SPEEDUPS MATMUL ####
WITH T_CPU AS (
SELECT
	Y.VL_TOTAL_EXECUTION_TIME,
	Y.VL_INTER_TASK_EXECUTION_TIME,
...
-- #### NEW EXTRA FIGURE 3 (MERGED WITH FIGURE 9) - SKEWED DATASETS KMEANS (MODE == 102) ####
WITH T_CPU AS (
SELECT
	Y.VL_TOTAL_EXECUTION_TIME,
	Y.VL_INTER_TASK_EXECUTION_TIME,
...
-- #### OLD VERSION EXTRA FIGURE 3 - SKEWED DATASETS KMEANS ####
SELECT
	Y.VL_TOTAL_EXECUTION_TIME,
	Y.VL_INTER_TASK_EXECUTION_TIME AS VL_PARALLEL_TASK_TIME,
	Y.VL_INTRA_TASK_EXECUTION_TIME_FULL_FUNC AS VL_USER_CODE_TIME,
