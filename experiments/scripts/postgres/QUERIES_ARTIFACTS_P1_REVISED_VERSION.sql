...
-- #### FIGURE 9(b). The effects of CPU-GPU communication and serial fraction processing on K-means and Matmul for different data skewness (MODE == 100) ####
WITH T_CPU AS (
SELECT
	Y.VL_TOTAL_EXECUTION_TIME,
	Y.VL_INTER_TASK_EXECUTION_TIME,
...
-- #### FIGURE 12 - ADDITIONAL ALGORITHM - MATMUL FMA (MODE == 100) ####
WITH T_CPU AS (
	SELECT
        Y.VL_TOTAL_EXECUTION_TIME,
        Y.VL_INTER_TASK_EXECUTION_TIME,
